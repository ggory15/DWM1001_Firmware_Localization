 ...
 *(.ARM.exidx* gnu.linkonce.armexidx.*)
 ...
 {
  __init_start = .;
  __init_PRE_KERNEL_1_start = .; KEEP(*(SORT(.init_PRE_KERNEL_1[0-9]_*))); KEEP(*(SORT(.init_PRE_KERNEL_1[1-9][0-9]_*)));
  __init_PRE_KERNEL_2_start = .; KEEP(*(SORT(.init_PRE_KERNEL_2[0-9]_*))); KEEP(*(SORT(.init_PRE_KERNEL_2[1-9][0-9]_*)));
  __init_POST_KERNEL_start = .; KEEP(*(SORT(.init_POST_KERNEL[0-9]_*))); KEEP(*(SORT(.init_POST_KERNEL[1-9][0-9]_*)));
  __init_APPLICATION_start = .; KEEP(*(SORT(.init_APPLICATION[0-9]_*))); KEEP(*(SORT(.init_APPLICATION[1-9][0-9]_*)));
  __init_SMP_start = .; KEEP(*(SORT(.init_SMP[0-9]_*))); KEEP(*(SORT(.init_SMP[1-9][0-9]_*)));
  __init_end = .;
 } > FLASH
 sw_isr_table :
 {
 ...
 *(".kernel.*")
 ...
 {
  __device_start = .;
  __device_PRE_KERNEL_1_start = .; KEEP(*(SORT(.device_PRE_KERNEL_1[0-9]_*))); KEEP(*(SORT(.device_PRE_KERNEL_1[1-9][0-9]_*)));
  __device_PRE_KERNEL_2_start = .; KEEP(*(SORT(.device_PRE_KERNEL_2[0-9]_*))); KEEP(*(SORT(.device_PRE_KERNEL_2[1-9][0-9]_*)));
  __device_POST_KERNEL_start = .; KEEP(*(SORT(.device_POST_KERNEL[0-9]_*))); KEEP(*(SORT(.device_POST_KERNEL[1-9][0-9]_*)));
  __device_APPLICATION_start = .; KEEP(*(SORT(.device_APPLICATION[0-9]_*))); KEEP(*(SORT(.device_APPLICATION[1-9][0-9]_*)));
  __device_SMP_start = .; KEEP(*(SORT(.device_SMP[0-9]_*))); KEEP(*(SORT(.device_SMP[1-9][0-9]_*)));
  __device_end = .;
 } > SRAM AT > FLASH
