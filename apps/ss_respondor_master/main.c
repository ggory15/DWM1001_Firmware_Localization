...
int main(void)
{
  ...
  LEDS_ON(BSP_LED_0_MASK | BSP_LED_1_MASK);
    ...
    UNUSED_VARIABLE(xTaskCreate(ss_responder_task_function, "SSTWR_RESP_MASTER", configMINIMAL_STACK_SIZE + 200, NULL, 2, &ss_responder_task_handle)); 
  #endif  // #ifdef USE_FREERTOS
  ...
  boUART_Init ();
  printf("Singled Sided Two Way Ranging Response Example \r\n");
  ...
  dwt_setrxtimeout(0);    // ggory15: Master should have timeout for auto-calibration
